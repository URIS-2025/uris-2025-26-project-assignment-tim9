...
{
    /// <summary>
    /// A minimal real HTTP server standing in for Project Service in integration tests, using
    /// HttpListener (built into .NET, no extra package) so the real HttpClient/
    /// IHttpClientFactory/JSON-deserialization path in ProjectService actually gets exercised.
    /// </summary>
